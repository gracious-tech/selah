...
//- NOTE `id` is required to connect Youtube API (assumed no more than one player in DOM at a time)
iframe(id='youtube' :src='src' allow='autoplay; encrypted-media; gyroscope; accelerometer')
...
export default class extends Vue {
    ...
    get src(){
        ...
        const params = new URLSearchParams([
            ...
            ['enablejsapi', '1'],  // Allow controlling video via JS API
        ])
